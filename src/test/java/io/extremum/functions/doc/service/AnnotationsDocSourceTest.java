...
class AnnotationsDocSourceTest {
    ...
    void should_get_doc_properly() {
        DocSource docSource = new AnnotationsDocSource(applicationContext, "io.extremum.functions");
        ...
        assertEquals(6, doc.getFunctions().size());
